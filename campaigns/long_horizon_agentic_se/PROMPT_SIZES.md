...
limits were raised and the dollar caps kept. Prices are OpenRouter list prices on that date,
without prompt caching: Opus 5 $5 / $25 and GPT-5.6 Sol $2 / $10 per million input / output tokens.
